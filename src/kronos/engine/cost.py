...
from kronos.config import budgets_config, providers_config
from kronos.models.budget import AssetCost, ProductionBudget
from kronos.models.retention import AssetType, RetentionPlan
...
class CostController:
    ...
    def estimate(self, retention_plan: RetentionPlan, budget_key: str) -> ProductionBudget:
        ...
        # Count generated images (non-video premium)
