...
from delta.config import scoring_config, channel_config
...
_QUALITATIVE_SCORE = {
    ...
    "evergreen": 0.5,
    "dated": 0.1,
    # saturation (inverted — lower saturation is better for competition_gap)
    "low": 1.0,
    "medium": 0.5,
    "high": 0.1,
    # monetization / title / thumbnail (these override saturation keys above)
    "excellent": 1.0,
    "high": 0.85,
    "good": 0.7,
    "medium": 0.5,
